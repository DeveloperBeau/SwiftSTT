...
public actor SileroVAD: VoiceActivityDetector {
    ...
    static func makeInputArray(samples: [Float]) throws(SwiftWhisperError) -> MLMultiArray {
    ...
    static func makeZeroState() throws(SwiftWhisperError) -> MLMultiArray {
        let array: MLMultiArray
        do {
...
extension SileroVAD {
    ...
    public static func load(
        from url: URL,
        threshold: Float = 0.5
    ) async throws(SwiftWhisperError) -> SileroVAD {
