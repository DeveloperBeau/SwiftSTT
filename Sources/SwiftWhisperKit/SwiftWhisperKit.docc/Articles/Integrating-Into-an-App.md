# Integrating SwiftWhisper into an iOS or macOS app
...
2. Enter the SwiftWhisper repository URL.
3. Pin to the latest minor version.
4. Add `SwiftWhisperKit` to your app target. `SwiftWhisperCore` is added automatically as a transitive dependency.

If you depend on the package directly in another Swift package:

```swift
.package(url: "https://github.com/<owner>/SwiftWhisper.git", from: "0.1.0"),
...
<string>SwiftWhisper transcribes your voice on-device. Audio never leaves your device.</string>
```
