...
/// All errors thrown across the SwiftSTT pipeline.
///
/// Every public protocol uses typed throws (`throws(SwiftSTTError)`), so callers
...
public enum SwiftSTTError: Error, Sendable, Equatable {
...
extension SwiftSTTError: LocalizedError {
